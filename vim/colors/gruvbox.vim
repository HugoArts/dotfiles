...
if &background == 'dark'
	let s:gb.darker0  = ['7c6f64', 233]     " 124-111-100
	let s:gb.darker1  = ['7c6f64', 234]     " 124-111-100
...
if version >= 703
	...
	call s:HL('ColorColumn',  'none', 'darker1')
...
call s:HL('SpecialKey', 'dark2', 'darker1')
...
call s:HL('LineNr', 'dark2', 'darker0')
